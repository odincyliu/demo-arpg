...
static func _core_components() -> Array[SkillComponent]:
    return [
        _core(&"core_slash", "Slash", "A short physical arc in front of the caster.",
            ...
            {"active_skill_id": &"slash", "core_behavior": &"melee", "shape_type": &"cone", "element": &"physical", "color": Color("d9e2ec")},
            [_op(&"damage", &"SET", 34.0), _op(&"cooldown", &"SET", 0.45), _op(&"area_radius", &"SET", 3.4), _op(&"spread_degrees", &"SET", 72.0)]),
        _core(&"core_rapid_slash", "Rapid Slash", "Three fast physical melee hits.",
            [&"melee", &"physical", &"hit", &"multi_hit", &"directional"], [&"can_hit"],
            {"active_skill_id": &"rapid_slash", "core_behavior": &"melee", "shape_type": &"cone", "element": &"physical", "color": Color("e7edf4")},
            [_op(&"damage", &"SET", 12.0), _op(&"cooldown", &"SET", 0.36), _op(&"repeat_count", &"SET", 3), _op(&"repeat_interval", &"SET", 0.09), _op(&"area_radius", &"SET", 3.0)]),
        _core(&"core_whirlblade", "Whirlblade", "A mobile channelling melee spin.",
            [&"melee", &"physical", &"hit", &"channel", &"aoe"], [&"can_hit", &"channel"],
            {"active_skill_id": &"whirlblade", "core_behavior": &"channel", "shape_type": &"circle", "element": &"physical", "color": Color("cfd9e6"), "channelled": true, "channel_can_move": true, "radial": true},
            [_op(&"damage", &"SET", 10.0), _op(&"cooldown", &"SET", 0.5), _op(&"area_radius", &"SET", 3.1), _op(&"channel_tick_interval", &"SET", 0.18)]),
        _core(&"core_earthbreaker", "Earthbreaker", "A slow, heavy physical ground slam.",
            [&"melee", &"physical", &"slam", &"aoe", &"hit", &"directional"], [&"can_hit"],
            {"active_skill_id": &"earthbreaker", "core_behavior": &"melee", "shape_type": &"cone", "element": &"physical", "color": Color("d8a56a")},
            [_op(&"damage", &"SET", 58.0), _op(&"cooldown", &"SET", 0.9), _op(&"area_radius", &"SET", 5.0), _op(&"spread_degrees", &"SET", 58.0)]),
        _core(&"core_dash_strike", "Dash Strike", "Dash forward and damage enemies on the path.",
            ...
            {"active_skill_id": &"dash_strike", "core_behavior": &"dash", "shape_type": &"line", "element": &"physical", "color": Color("9ad8ff")},
            [_op(&"damage", &"SET", 30.0), _op(&"cooldown", &"SET", 0.7), _op(&"target_range", &"SET", 5.0)]),
        _core(&"core_shockwave", "Shockwave", "A wide physical wave travelling in a direction.",
            [&"physical", &"wave", &"directional", &"aoe", &"hit"], [&"can_hit", &"movable_instance", &"can_store", &"path_instance"],
            {"active_skill_id": &"shockwave", "core_behavior": &"projectile", "shape_type": &"line", "element": &"physical", "color": Color("e5c58d")},
        ...
        _core(&"core_ground_burst", "Ground Burst", "A physical eruption at the target point.",
            ...
            {"active_skill_id": &"ground_burst", "core_behavior": &"ground", "shape_type": &"circle", "element": &"physical", "color": Color("c9985f"), "radial": true},
            [_op(&"damage", &"SET", 36.0), _op(&"cooldown", &"SET", 0.65), _op(&"area_radius", &"SET", 2.5), _op(&"target_range", &"SET", 10.0)], &"target"),
        _core(&"core_explosion", "Explosion", "A neutral area explosion whose identity comes from Components.",
            [&"aoe", &"hit"], [&"can_hit"],
            {"active_skill_id": &"explosion", "core_behavior": &"area", "shape_type": &"circle", "element": &"neutral", "color": Color("f2d18a"), "radial": true},
            [_op(&"damage", &"SET", 40.0), _op(&"cooldown", &"SET", 0.75), _op(&"area_radius", &"SET", 2.8)], &"event"),
        _core(&"core_blade_burst", "Blade Burst", "Launch physical blades in every direction.",
            [&"physical", &"projectile", &"aoe", &"hit"], [&"can_hit", &"movable_instance", &"can_store", &"can_return", &"path_instance"],
            {"active_skill_id": &"blade_burst", "core_behavior": &"projectile", "shape_type": &"circle", "element": &"physical", "color": Color("dbe6f0"), "radial": true},
            [_op(&"damage", &"SET", 14.0), _op(&"cooldown", &"SET", 0.7), _op(&"projectile_count", &"SET", 6), _op(&"projectile_speed", &"SET", 13.0)]),
        _core(&"core_arrow_shot", "Arrow Shot", "A fast straight physical projectile.",
            ...
            {"active_skill_id": &"arrow_shot", "core_behavior": &"projectile", "shape_type": &"line", "element": &"physical", "color": Color("d5f0b6")},
            [_op(&"damage", &"SET", 30.0), _op(&"cooldown", &"SET", 0.42), _op(&"projectile_speed", &"SET", 20.0)]),
        _core(&"core_returning_blade", "Returning Blade", "A large slow spinning physical blade; Return remains optional.",
            [&"physical", &"projectile", &"attack", &"hit", &"directional"], [&"can_hit", &"movable_instance", &"can_store", &"can_return", &"path_instance"],
            {"active_skill_id": &"returning_blade", "core_behavior": &"projectile", "shape_type": &"line", "element": &"physical", "color": Color("c7d8e9")},
            [_op(&"damage", &"SET", 38.0), _op(&"cooldown", &"SET", 0.75), _op(&"projectile_speed", &"SET", 11.0)]),
        _core(&"core_frost_lance", "Frost Lance", "A fast cold spell projectile.",
            ...
            {"active_skill_id": &"frost_lance", "core_behavior": &"projectile", "shape_type": &"line", "element": &"cold", "color": Color("72d9ff")},
            [_op(&"damage", &"SET", 27.0), _op(&"cooldown", &"SET", 0.48), _op(&"projectile_speed", &"SET", 18.0)]),
        _core(&"core_flame_orb", "Flame Orb", "A medium-speed fire spell projectile.",
            [&"fire", &"projectile", &"spell", &"hit", &"directional"], [&"can_hit", &"movable_instance", &"can_store", &"can_return", &"path_instance"],
            {"active_skill_id": &"flame_orb", "core_behavior": &"projectile", "shape_type": &"line", "element": &"fire", "color": Color("ff7b45")},
            [_op(&"damage", &"SET", 34.0), _op(&"cooldown", &"SET", 0.55), _op(&"projectile_speed", &"SET", 13.0)]),
        _core(&"core_frost_nova", "Frost Nova", "A cold spell centred on its cast position.",
            [&"cold", &"spell", &"aoe", &"hit"], [&"can_hit"],
            {"active_skill_id": &"frost_nova", "core_behavior": &"area", "shape_type": &"circle", "element": &"cold", "color": Color("78e2ff"), "radial": true},
        ...
        _core(&"core_chain_lightning", "Chain Lightning", "Strike a target and use the shared Chain operation.",
            ...
            {"active_skill_id": &"chain_lightning", "core_behavior": &"chain", "shape_type": &"tracking", "element": &"lightning", "color": Color("91dcff")},
        ...
        _core(&"core_meteor", "Meteor", "A delayed high-damage fire impact at a target area.",
            ...
            {"active_skill_id": &"meteor", "core_behavior": &"meteor", "shape_type": &"circle", "element": &"fire", "color": Color("ff9a55"), "radial": true},
        ...
        _core(&"core_void_beam", "Void Beam", "A stationary chaos beam maintained while channelling.",
            ...
            {"active_skill_id": &"void_beam", "core_behavior": &"channel", "shape_type": &"line", "element": &"chaos", "color": Color("bd83ff"), "channelled": true, "channel_can_move": false},
            [_op(&"damage", &"SET", 8.0), _op(&"cooldown", &"SET", 0.6), _op(&"target_range", &"SET", 11.0), _op(&"channel_tick_interval", &"SET", 0.12)]),
        _core(&"core_blood_burst", "Blood Burst", "A physical spell burst suitable for Bleed.",
            [&"physical", &"spell", &"aoe", &"hit"], [&"can_hit"],
            {"active_skill_id": &"blood_burst", "core_behavior": &"area", "shape_type": &"circle", "element": &"physical", "color": Color("c93556"), "radial": true},
            [_op(&"damage", &"SET", 36.0), _op(&"cooldown", &"SET", 0.65), _op(&"area_radius", &"SET", 3.0)], &"event"),
        _core(&"core_void_rift", "Void Rift", "A persistent chaos damage area.",
            [&"chaos", &"spell", &"ground", &"persistent"], [],
            {"active_skill_id": &"void_rift", "core_behavior": &"persistent", "shape_type": &"circle", "element": &"chaos", "color": Color("8f5bd9"), "radial": true},
        ...
        _core(&"core_summon", "Summon", "Create a temporary ranged follower.",
            [&"minion", &"spell", &"summon"], [],
            {"active_skill_id": &"summon", "core_behavior": &"summon", "shape_type": &"tracking", "element": &"neutral", "color": Color("ffd16c")},
...
static func _trajectory_components() -> Array[SkillComponent]:
    return [
        _component(&"trajectory_pierce", "Pierce", &"Trajectory", "Pass through three extra targets.", {"requires_tags_any": [&"projectile", &"wave"], "stats": [_op(&"pierce_count", &"ADD", 3)]}),
